        ...
        <div className="flex w-full h-full flex-wrap items-center justify-center ">
          ...
          <div className="md:w-8/12 lg:ms-2 lg:w-5/12 md:mt-[10rem]">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div title="link no disponible, favor de comunicarse con supervisor"  className=" my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-neutral-300 after:mt-0.5 after:flex-1 after:border-t after:border-neutral-300 dark:before:border-neutral-500 dark:after:border-neutral-500">
                <p className="pointer-events-none mx-4 mb-0 text-center font-semibold dark:text-neutral-200">
                  {" "}
